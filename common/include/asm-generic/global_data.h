...
# if defined(CONFIG_OF_PLATDATA_DRIVER_RT)
	/** @dm_driver_rt: Dynamic info about the driver */
	struct driver_rt *dm_driver_rt;
# endif
#if defined(CONFIG_OF_PLATDATA_RT)
...
#if defined(CONFIG_SYS_MALLOC_F_LEN) && CONFIG_SYS_MALLOC_F_LEN > 0
	/**
