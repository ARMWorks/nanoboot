...
dd if=/dev/zero bs=512 count=127 2> /dev/null | tr "\000" "\377" > nanoboot.bin
...
dd if=bl1-sdcard/build/${PROFILE}/bl1.bin of=nanoboot.bin conv=notrunc 2> /dev/null
dd if=bl2/build/${PROFILE}/bl2.bin of=nanoboot.bin bs=1k seek=16 conv=notrunc 2> /dev/null
