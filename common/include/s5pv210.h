...
#define GPA0CON_REG						(ELFIN_GPIO_BASE+0x000)
#define GPA0DAT_REG						(ELFIN_GPIO_BASE+0x004)
#define GPA0PUD_REG						(ELFIN_GPIO_BASE+0x008)
#define GPA0DRV_SR_REG					(ELFIN_GPIO_BASE+0x00C)
#define GPA0CONPDN_REG					(ELFIN_GPIO_BASE+0x010)
#define GPA0PUDPDN_REG					(ELFIN_GPIO_BASE+0x014)

#define GPA1CON_REG						(ELFIN_GPIO_BASE+0x020)
#define GPA1DAT_REG						(ELFIN_GPIO_BASE+0x024)
#define GPA1PUD_REG						(ELFIN_GPIO_BASE+0x028)
#define GPA1DRV_SR_REG					(ELFIN_GPIO_BASE+0x02C)
#define GPA1CONPDN_REG					(ELFIN_GPIO_BASE+0x030)
#define GPA1PUDPDN_REG					(ELFIN_GPIO_BASE+0x034)

#define GPBCON_REG						(ELFIN_GPIO_BASE+0x040)
#define GPBDAT_REG						(ELFIN_GPIO_BASE+0x044)
#define GPBPUD_REG						(ELFIN_GPIO_BASE+0x048)
#define GPBDRV_SR_REG					(ELFIN_GPIO_BASE+0x04C)
#define GPBCONPDN_REG					(ELFIN_GPIO_BASE+0x050)
#define GPBPUDPDN_REG					(ELFIN_GPIO_BASE+0x054)

#define GPC0CON_REG						(ELFIN_GPIO_BASE+0x060)
#define GPC0DAT_REG						(ELFIN_GPIO_BASE+0x064)
#define GPC0PUD_REG						(ELFIN_GPIO_BASE+0x068)
#define GPC0DRV_SR_REG					(ELFIN_GPIO_BASE+0x06C)
#define GPC0CONPDN_REG					(ELFIN_GPIO_BASE+0x070)
#define GPC0PUDPDN_REG					(ELFIN_GPIO_BASE+0x074)

#define GPC1CON_REG						(ELFIN_GPIO_BASE+0x080)
#define GPC1DAT_REG						(ELFIN_GPIO_BASE+0x084)
#define GPC1PUD_REG						(ELFIN_GPIO_BASE+0x088)
#define GPC1DRV_SR_REG					(ELFIN_GPIO_BASE+0x08C)
#define GPC1CONPDN_REG					(ELFIN_GPIO_BASE+0x090)
#define GPC1PUDPDN_REG					(ELFIN_GPIO_BASE+0x094)

#define GPD0CON_REG						(ELFIN_GPIO_BASE+0x0A0)
#define GPD0DAT_REG						(ELFIN_GPIO_BASE+0x0A4)
#define GPD0PUD_REG						(ELFIN_GPIO_BASE+0x0A8)
#define GPD0DRV_SR_REG					(ELFIN_GPIO_BASE+0x0AC)
#define GPD0CONPDN_REG					(ELFIN_GPIO_BASE+0x0B0)
#define GPD0PUDPDN_REG					(ELFIN_GPIO_BASE+0x0B4)

#define GPD1CON_REG						(ELFIN_GPIO_BASE+0x0C0)
#define GPD1DAT_REG						(ELFIN_GPIO_BASE+0x0C4)
#define GPD1PUD_REG						(ELFIN_GPIO_BASE+0x0C8)
#define GPD1DRV_SR_REG					(ELFIN_GPIO_BASE+0x0CC)
#define GPD1CONPDN_REG					(ELFIN_GPIO_BASE+0x0D0)
#define GPD1PUDPDN_REG					(ELFIN_GPIO_BASE+0x0D4)

#define GPE0CON_REG						(ELFIN_GPIO_BASE+0x0E0)
#define GPE0DAT_REG						(ELFIN_GPIO_BASE+0x0E4)
#define GPE0PUD_REG						(ELFIN_GPIO_BASE+0x0E8)
#define GPE0DRV_SR_REG					(ELFIN_GPIO_BASE+0x0EC)
#define GPE0CONPDN_REG					(ELFIN_GPIO_BASE+0x0F0)
#define GPE0PUDPDN_REG					(ELFIN_GPIO_BASE+0x0F4)

#define GPE1CON_REG						(ELFIN_GPIO_BASE+0x100)
#define GPE1DAT_REG						(ELFIN_GPIO_BASE+0x104)
#define GPE1PUD_REG						(ELFIN_GPIO_BASE+0x108)
#define GPE1DRV_SR_REG					(ELFIN_GPIO_BASE+0x10C)
#define GPE1CONPDN_REG					(ELFIN_GPIO_BASE+0x110)
#define GPE1PUDPDN_REG					(ELFIN_GPIO_BASE+0x114)

#define GPF0CON_REG						(ELFIN_GPIO_BASE+0x120)
#define GPF0DAT_REG						(ELFIN_GPIO_BASE+0x124)
#define GPF0PUD_REG						(ELFIN_GPIO_BASE+0x128)
#define GPF0DRV_SR_REG					(ELFIN_GPIO_BASE+0x12C)
#define GPF0CONPDN_REG					(ELFIN_GPIO_BASE+0x130)
#define GPF0PUDPDN_REG					(ELFIN_GPIO_BASE+0x134)

#define GPF1CON_REG						(ELFIN_GPIO_BASE+0x140)
#define GPF1DAT_REG						(ELFIN_GPIO_BASE+0x144)
#define GPF1PUD_REG						(ELFIN_GPIO_BASE+0x148)
#define GPF1DRV_SR_REG					(ELFIN_GPIO_BASE+0x14C)
#define GPF1CONPDN_REG					(ELFIN_GPIO_BASE+0x150)
#define GPF1PUDPDN_REG					(ELFIN_GPIO_BASE+0x154)

#define GPF2CON_REG						(ELFIN_GPIO_BASE+0x160)
#define GPF2DAT_REG						(ELFIN_GPIO_BASE+0x164)
#define GPF2PUD_REG						(ELFIN_GPIO_BASE+0x168)
#define GPF2DRV_SR_REG					(ELFIN_GPIO_BASE+0x16C)
#define GPF2CONPDN_REG					(ELFIN_GPIO_BASE+0x170)
#define GPF2PUDPDN_REG					(ELFIN_GPIO_BASE+0x174)

#define GPF3CON_REG						(ELFIN_GPIO_BASE+0x180)
#define GPF3DAT_REG						(ELFIN_GPIO_BASE+0x184)
#define GPF3PUD_REG						(ELFIN_GPIO_BASE+0x188)
#define GPF3DRV_SR_REG					(ELFIN_GPIO_BASE+0x18C)
#define GPF3CONPDN_REG					(ELFIN_GPIO_BASE+0x190)
#define GPF3PUDPDN_REG					(ELFIN_GPIO_BASE+0x194)

#define GPG0CON_REG						(ELFIN_GPIO_BASE+0x1A0)
#define GPG0DAT_REG						(ELFIN_GPIO_BASE+0x1A4)
#define GPG0PUD_REG						(ELFIN_GPIO_BASE+0x1A8)
#define GPG0DRV_SR_REG					(ELFIN_GPIO_BASE+0x1AC)
#define GPG0CONPDN_REG					(ELFIN_GPIO_BASE+0x1B0)
#define GPG0PUDPDN_REG					(ELFIN_GPIO_BASE+0x1B4)

#define GPG1CON_REG						(ELFIN_GPIO_BASE+0x1C0)
#define GPG1DAT_REG						(ELFIN_GPIO_BASE+0x1C4)
#define GPG1PUD_REG						(ELFIN_GPIO_BASE+0x1C8)
#define GPG1DRV_SR_REG					(ELFIN_GPIO_BASE+0x1CC)
#define GPG1CONPDN_REG					(ELFIN_GPIO_BASE+0x1D0)
#define GPG1PUDPDN_REG					(ELFIN_GPIO_BASE+0x1D4)

#define GPG2CON_REG						(ELFIN_GPIO_BASE+0x1E0)
#define GPG2DAT_REG						(ELFIN_GPIO_BASE+0x1E4)
#define GPG2PUD_REG						(ELFIN_GPIO_BASE+0x1E8)
#define GPG2DRV_SR_REG					(ELFIN_GPIO_BASE+0x1EC)
#define GPG2CONPDN_REG					(ELFIN_GPIO_BASE+0x1F0)
#define GPG2PUDPDN_REG					(ELFIN_GPIO_BASE+0x1F4)

#define GPG3CON_REG						(ELFIN_GPIO_BASE+0x200)
#define GPG3DAT_REG						(ELFIN_GPIO_BASE+0x204)
#define GPG3PUD_REG						(ELFIN_GPIO_BASE+0x208)
#define GPG3DRV_SR_REG					(ELFIN_GPIO_BASE+0x20C)
#define GPG3CONPDN_REG					(ELFIN_GPIO_BASE+0x210)
#define GPG3PUDPDN_REG					(ELFIN_GPIO_BASE+0x214)

#define MP01CON_REG						(ELFIN_GPIO_BASE+0x2E0)
#define MP01DAT_REG						(ELFIN_GPIO_BASE+0x2E4)
#define MP01PUD_REG						(ELFIN_GPIO_BASE+0x2E8)
#define MP01DRV_SR_REG					(ELFIN_GPIO_BASE+0x2EC)
#define MP01CONPDN_REG					(ELFIN_GPIO_BASE+0x2E0)
#define MP01PUDPDN_REG					(ELFIN_GPIO_BASE+0x2E4)

#define MP02CON_REG						(ELFIN_GPIO_BASE+0x300)
#define MP02DAT_REG						(ELFIN_GPIO_BASE+0x304)
#define MP02PUD_REG						(ELFIN_GPIO_BASE+0x308)
#define MP02DRV_SR_REG					(ELFIN_GPIO_BASE+0x30c)
#define MP02CONPDN_REG					(ELFIN_GPIO_BASE+0x310)
#define MP02PUDPDN_REG					(ELFIN_GPIO_BASE+0x314)

#define MP03CON_REG						(ELFIN_GPIO_BASE+0x320)
#define MP03DAT_REG						(ELFIN_GPIO_BASE+0x324)
#define MP03PUD_REG						(ELFIN_GPIO_BASE+0x328)
#define MP03DRV_SR_REG					(ELFIN_GPIO_BASE+0x32c)
#define MP03CONPDN_REG					(ELFIN_GPIO_BASE+0x330)
#define MP03PUDPDN_REG					(ELFIN_GPIO_BASE+0x334)

#define MP06CON_REG						(ELFIN_GPIO_BASE+0x380)
#define MP06DAT_REG						(ELFIN_GPIO_BASE+0x384)
#define MP06PUD_REG						(ELFIN_GPIO_BASE+0x388)
#define MP06DRV_SR_REG					(ELFIN_GPIO_BASE+0x38C)
#define MP06CONPDN_REG					(ELFIN_GPIO_BASE+0x390)
#define MP06PUDPDN_REG					(ELFIN_GPIO_BASE+0x394)

#define MP07CON_REG						(ELFIN_GPIO_BASE+0x3A0)
#define MP07DAT_REG						(ELFIN_GPIO_BASE+0x3A4)
#define MP07PUD_REG						(ELFIN_GPIO_BASE+0x3A8)
#define MP07DRV_SR_REG					(ELFIN_GPIO_BASE+0x3AC)
#define MP07CONPDN_REG					(ELFIN_GPIO_BASE+0x3B0)
#define MP07PUDPDN_REG					(ELFIN_GPIO_BASE+0x3B4)

#define MP1_0DRV_SR_REG					(ELFIN_GPIO_BASE+0x3CC)
#define MP1_1DRV_SR_REG					(ELFIN_GPIO_BASE+0x3EC)
#define MP1_2DRV_SR_REG					(ELFIN_GPIO_BASE+0x40C)
#define MP1_3DRV_SR_REG					(ELFIN_GPIO_BASE+0x42C)
#define MP1_4DRV_SR_REG					(ELFIN_GPIO_BASE+0x44C)
#define MP1_5DRV_SR_REG					(ELFIN_GPIO_BASE+0x46C)
#define MP1_6DRV_SR_REG					(ELFIN_GPIO_BASE+0x48C)
#define MP1_7DRV_SR_REG					(ELFIN_GPIO_BASE+0x4AC)
#define MP1_8DRV_SR_REG					(ELFIN_GPIO_BASE+0x4CC)

#define MP2_0DRV_SR_REG					(ELFIN_GPIO_BASE+0x4EC)
#define MP2_1DRV_SR_REG					(ELFIN_GPIO_BASE+0x50C)
#define MP2_2DRV_SR_REG					(ELFIN_GPIO_BASE+0x52C)
#define MP2_3DRV_SR_REG					(ELFIN_GPIO_BASE+0x54C)
#define MP2_4DRV_SR_REG					(ELFIN_GPIO_BASE+0x56C)
#define MP2_5DRV_SR_REG					(ELFIN_GPIO_BASE+0x58C)
#define MP2_6DRV_SR_REG					(ELFIN_GPIO_BASE+0x5AC)
#define MP2_7DRV_SR_REG					(ELFIN_GPIO_BASE+0x5CC)
#define MP2_8DRV_SR_REG					(ELFIN_GPIO_BASE+0x5EC)

/* GPH0 */
#define GPH0CON_REG						(ELFIN_GPIO_BASE+0xc00)
#define GPH0DAT_REG						(ELFIN_GPIO_BASE+0xc04)
#define GPH0PUD_REG						(ELFIN_GPIO_BASE+0xc08)
#define GPH0DRV_REG						(ELFIN_GPIO_BASE+0xc0c)

/* GPH1 */
#define GPH1CON_REG						(ELFIN_GPIO_BASE+0xc20)
#define GPH1DAT_REG						(ELFIN_GPIO_BASE+0xc24)
#define GPH1PUD_REG						(ELFIN_GPIO_BASE+0xc28)
#define GPH1DRV_REG						(ELFIN_GPIO_BASE+0xc2c)

/* GPH2 */
#define GPH2CON_REG						(ELFIN_GPIO_BASE+0xc40)
#define GPH2DAT_REG						(ELFIN_GPIO_BASE+0xc44)
#define GPH2PUD_REG						(ELFIN_GPIO_BASE+0xc48)
#define GPH2DRV_REG						(ELFIN_GPIO_BASE+0xc4c)

/* GPH3 */
#define GPH3CON_REG						(ELFIN_GPIO_BASE+0xc60)
#define GPH3DAT_REG						(ELFIN_GPIO_BASE+0xc64)
#define GPH3PUD_REG						(ELFIN_GPIO_BASE+0xc68)
#define GPH3DRV_REG						(ELFIN_GPIO_BASE+0xc6c)


#define GPICON_REG						(ELFIN_GPIO_BASE+0x220)
#define GPIPUD_REG						(ELFIN_GPIO_BASE+0x228)
#define GPIDRV_SR_REG					(ELFIN_GPIO_BASE+0x22C)
#define GPIPUDPDN_REG					(ELFIN_GPIO_BASE+0x234)

#define GPJ0CON_REG						(ELFIN_GPIO_BASE+0x240)
#define GPJ0DAT_REG						(ELFIN_GPIO_BASE+0x244)
#define GPJ0PUD_REG						(ELFIN_GPIO_BASE+0x248)
#define GPJ0DRV_SR_REG					(ELFIN_GPIO_BASE+0x24C)
#define GPJ0CONPDN_REG					(ELFIN_GPIO_BASE+0x250)
#define GPJ0PUDPDN_REG					(ELFIN_GPIO_BASE+0x254)

#define GPJ1CON_REG						(ELFIN_GPIO_BASE+0x260)
#define GPJ1DAT_REG						(ELFIN_GPIO_BASE+0x264)
#define GPJ1PUD_REG						(ELFIN_GPIO_BASE+0x268)
#define GPJ1DRV_SR_REG					(ELFIN_GPIO_BASE+0x26C)
#define GPJ1CONPDN_REG					(ELFIN_GPIO_BASE+0x270)
#define GPJ1PUDPDN_REG					(ELFIN_GPIO_BASE+0x274)

#define GPJ2CON_REG						(ELFIN_GPIO_BASE+0x280)
#define GPJ2DAT_REG						(ELFIN_GPIO_BASE+0x284)
#define GPJ2PUD_REG						(ELFIN_GPIO_BASE+0x288)
#define GPJ2DRV_SR_REG					(ELFIN_GPIO_BASE+0x28C)
#define GPJ2CONPDN_REG					(ELFIN_GPIO_BASE+0x290)
#define GPJ2PUDPDN_REG					(ELFIN_GPIO_BASE+0x294)

#define GPJ3CON_REG						(ELFIN_GPIO_BASE+0x2A0)
#define GPJ3DAT_REG						(ELFIN_GPIO_BASE+0x2A4)
#define GPJ3PUD_REG						(ELFIN_GPIO_BASE+0x2A8)
#define GPJ3DRV_SR_REG					(ELFIN_GPIO_BASE+0x2AC)
#define GPJ3CONPDN_REG					(ELFIN_GPIO_BASE+0x2B0)
#define GPJ3PUDPDN_REG					(ELFIN_GPIO_BASE+0x2B4)

#define GPJ4CON_REG						(ELFIN_GPIO_BASE+0x2C0)
#define GPJ4DAT_REG						(ELFIN_GPIO_BASE+0x2C4)
#define GPJ4PUD_REG						(ELFIN_GPIO_BASE+0x2C8)
#define GPJ4DRV_SR_REG					(ELFIN_GPIO_BASE+0x2CC)
#define GPJ4CONPDN_REG					(ELFIN_GPIO_BASE+0x2D0)
#define GPJ4PUDPDN_REG					(ELFIN_GPIO_BASE+0x2D4)

#define EXT_INT_0_CON_REG				(ELFIN_GPIO_BASE+0xE00)
#define EXT_INT_1_CON_REG				(ELFIN_GPIO_BASE+0xE04)
#define EXT_INT_2_CON_REG				(ELFIN_GPIO_BASE+0xE08)
#define EXT_INT_3_CON_REG				(ELFIN_GPIO_BASE+0xE0C)

#define EXT_INT_0_FLTCON0_REG			(ELFIN_GPIO_BASE+0xE80)
#define EXT_INT_0_FLTCON1_REG			(ELFIN_GPIO_BASE+0xE84)
#define EXT_INT_1_FLTCON0_REG			(ELFIN_GPIO_BASE+0xE88)
#define EXT_INT_1_FLTCON1_REG			(ELFIN_GPIO_BASE+0xE8C)
#define EXT_INT_2_FLTCON0_REG			(ELFIN_GPIO_BASE+0xE90)
#define EXT_INT_2_FLTCON1_REG			(ELFIN_GPIO_BASE+0xE94)
#define EXT_INT_3_FLTCON0_REG			(ELFIN_GPIO_BASE+0xE98)
#define EXT_INT_3_FLTCON1_REG			(ELFIN_GPIO_BASE+0xE9C)
#define EXT_INT_0_MASK_REG				(ELFIN_GPIO_BASE+0xF00)
#define EXT_INT_1_MASK_REG				(ELFIN_GPIO_BASE+0xF04)
#define EXT_INT_2_MASK_REG				(ELFIN_GPIO_BASE+0xF08)
#define EXT_INT_3_MASK_REG				(ELFIN_GPIO_BASE+0xF0C)
#define EXT_INT_0_PEND_REG				(ELFIN_GPIO_BASE+0xF40)
#define EXT_INT_1_PEND_REG				(ELFIN_GPIO_BASE+0xF44)
#define EXT_INT_2_PEND_REG				(ELFIN_GPIO_BASE+0xF48)
#define EXT_INT_3_PEND_REG				(ELFIN_GPIO_BASE+0xF4C)
#define PDNEN_REG						(ELFIN_GPIO_BASE+0xF80)
...
#define NFCONF_MSGLEN_512				(0<<25)
#define NFCONF_MSGLEN_24				(1<<25)
...
#define NFCONF_TACLS_SHIFT				12
#define NFCONF_TACLS_MASK				(0xf<<12)
#define NFCONF_TACLS(_x)				((_x)<<12)
#define NFCONF_TWRPH0_SHIFT				8
#define NFCONF_TWRPH0_MASK				(0xf<<8)
#define NFCONF_TWRPH0(_x)				((_x)<<8)
#define NFCONF_TWRPH1_SHIFT				4
#define NFCONF_TWRPH1_MASK				(0xf<<4)
#define NFCONF_TWRPH1(_x)				((_x)<<4)
#define NFCONF_SLC_2048_4ADDR			(0<<1)
#define NFCONF_SLC_2048_5ADDR			(1<<1)
#define NFCONF_SLC_512_3ADDR			(2<<1)
#define NFCONF_SLC_512_4ADDR			(3<<1)
#define NFCONF_MLC_4096_4ADDR			(4<<1)
#define NFCONF_MLC_4096_5ADDR			(5<<1)
#define NFCONF_MLC_2048_4ADDR			(6<<1)
#define NFCONF_MLC_2048_5ADDR			(7<<1)

#define NFCONT_CS3						(1<<23)
#define NFCONT_CS2						(1<<22)
...
#define NFCONT_CS1						(1<<2)
#define NFCONT_CS0						(1<<1)
...
#define NFECCCONF_MSGLENGTH_SHIFT		16
#define NFECCCONF_MSGLENGTH_MASK		(0x3FF<<16)
#define NFECCCONF_MSGLENGTH(_x)			((_x)<<16)
#define NFECCCONF_STRENGTH_MASK			(7<<0)
#define NFECCCONF_MODE_DISABLE			(0<<0)
#define NFECCCONF_MODE_8BIT				(3<<0)
#define NFECCCONF_MODE_12BIT			(4<<0)
#define NFECCCONF_MODE_16BIT			(5<<0)

#define NFECCCONT_ENC_INT				(1<<25)
#define NFECCCONT_DEC_INT				(1<<24)
#define NFECCCONT_DECODE				(0<<16)
#define NFECCCONT_ENCODE				(1<<16)
#define NFECCCONT_INITMECC				(1<<2)
#define NFECCCONT_RESET					(1<<0)
...
#define NFECCSECSTAT_VALID_SHIFT		8
#define NFECCSECSTAT_VALID_MASK			(0xFFFFFF<<8)
#define NFECCSECSTAT_ERRNO_SHIFT		0
#define NFECCSECSTAT_ERRNO_MASK			(31<<0)
